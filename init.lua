...
local function SaveBuffer()
	-- Check if the current buffer is modifiable and can be written
...
-- set netrw display to tree mode!!!
...
-- resize splits
--vim.keymap.set("n", "<A-,>", vim.cmd("resize -5"))

-- My keymaps
vim.keymap.set("n", "<Leader>e", function()
	SaveBuffer()
	local dir = vim.cmd.pwd()
	vim.cmd("Explore" .. dir)
end)
...
-- delete to the null buffer I think
vim.keymap.set({ "n", "v" }, "<leader>d", [["_d]])

-- IDK what this does but I never use it
vim.keymap.set("n", "Q", "<nop>")
